{{--
    Halaman error 404 ber-branding RSUD (Requirement 28.1).
    SENGAJA self-contained: TIDAK @extends('layouts.public') karena layout publik
    memuat partial yang mengambil data dari database (SiteSettingService,
    navbar, footer, theme color). Halaman error harus tetap tampil meski
    database/komponen lain bermasalah, sehingga semua gaya di-inline.
--}}
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | RSUD</title>
    <style>
...
<body>
    <main class="card">
        ...
        <p>Maaf, halaman yang Anda cari tidak tersedia atau mungkin telah dipindahkan. Silakan kembali ke beranda untuk melanjutkan.</p>
