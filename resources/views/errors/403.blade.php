{{--
    Halaman error 403 ber-branding RSUD (kelengkapan Requirement 28).
    Ditampilkan ketika akses ke resource ditolak. SENGAJA self-contained: tidak
    @extends('layouts.public') maupun memanggil SiteSettingService/navbar/footer
    yang mengambil data dari database. Semua gaya di-inline.
--}}
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>403 - Akses Ditolak | RSUD</title>
    <style>
...
<body>
    <main class="card">
        ...
        <h1>Akses ditolak</h1>
        <p>Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silakan kembali ke beranda untuk melanjutkan.</p>
